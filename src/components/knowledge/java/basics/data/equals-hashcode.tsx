        ...
        System.out.println(Objects.equals(nullStr, "test")); // false (安全)
            ...
            <div className="card bg-base-100 border border-base-300">
                <div className="card-body">
                    <h4 className="font-bold mb-3">📝 字符串比较：常量池的影响</h4>
                    <div className="grid md:grid-cols-2 gap-4">
                        <div>
                            <h5 className="font-semibold text-warning mb-2">⚠️ 容易混淆的情况</h5>
...
String prefix = "hel";
String s8 = prefix + "lo";
System.out.println(s1 == s8); // false`}</code></pre>
                            </div>
                        </div>
...
for (User user : users) {
    roles.add(user.getRole().intern());
                            ...
                            <div className="alert alert-info mt-2">
                                <span className="text-xs"><strong>注意：</strong>过度使用intern()可能导致永久代/元空间内存泄漏</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="card bg-base-100 border border-base-300">
                <div className="card-body">
                    <h4 className="font-bold mb-3">🤝 equals() 和 hashCode() 协定</h4>
                    <div className="space-y-4">
                        {/* 协定规则 */}
                        <div>
                            <h5 className="font-semibold text-error mb-2">📋 强制性协定</h5>
                            <div className="grid md:grid-cols-2 gap-4 text-sm">
                                <div className="card bg-error/5 border border-error/20 p-3">
                                    <h6 className="font-semibold mb-1">🔴 核心规则</h6>
                                ...
                                <div className="card bg-warning/5 border border-warning/20 p-3">
                                    <h6 className="font-semibold mb-1">⚠️ 违反后果</h6>
                                    <ul className="space-y-1">
                        ...
                        {/* equals() 规范 */}
                        <div>
                            <h5 className="font-semibold text-success mb-2">✅ equals() 方法规范</h5>
                            <div className="grid md:grid-cols-2 gap-4">
                                <div>
                                    <h6 className="font-semibold text-xs mb-1">五大特性</h6>
                                ...
                                <div>
                                    <h6 className="font-semibold text-xs mb-1">标准实现模板</h6>
                                    <div className="mockup-code text-xs">
                                        <pre><code>{`@Override
public boolean equals(Object obj) {
    ...
    return Objects.equals(name, other.name) 
        ...
        && Objects.equals(email, other.email);
                        ...
                        {/* hashCode() 实现 */}
                        <div>
                            <h5 className="font-semibold text-info mb-2">🔢 hashCode() 实现策略</h5>
                            <div className="grid md:grid-cols-2 gap-4">
                                <div>
                                    <h6 className="font-semibold text-xs mb-1">常用算法</h6>
                                    <div className="mockup-code text-xs">
                                        <pre><code>{`// 方法1: Objects.hash() (推荐)
@Override
public int hashCode() {
...
public int hashCode() {
    return Arrays.hashCode(new Object[]{name, age, email});
                                ...
                                <div>
                                    <h6 className="font-semibold text-xs mb-1">设计考虑</h6>
                                    <ul className="text-xs space-y-1">
                                    ...
                                    <div className="alert alert-warning mt-2">
                                        <span className="text-xs"><strong>为什么用31？</strong>31是质数，31*i可以优化为(i&lt;&lt;5)-i，性能更好</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="card bg-base-100 border border-base-300">
                <div className="card-body">
                    <h4 className="font-bold mb-3">💼 实际应用示例</h4>
                    <div className="grid md:grid-cols-2 gap-4">
                        <div>
                            <h5 className="font-semibold text-error mb-2">❌ 错误示例</h5>
                            <div className="mockup-code text-xs">
                                <pre><code>{`public class BadPerson {
    private String name;
    private int age;
...
System.out.println(set.size()); // 2! 应该是1`}</code></pre>
                            </div>
                        </div>
                        
                        <div>
                            <h5 className="font-semibold text-success mb-2">✅ 正确示例</h5>
                            <div className="mockup-code text-xs">
                                <pre><code>{`public class GoodPerson {
    private String name;
    private int age;
...
System.out.println(set.size()); // 1 ✅`}</code></pre>
            ...
            <div className="card bg-base-100 border border-base-300">
                <div className="card-body">
                    <h4 className="font-bold mb-3">⚡ 性能优化与注意事项</h4>
                    <div className="grid md:grid-cols-2 gap-4 text-sm">
                        <div>
